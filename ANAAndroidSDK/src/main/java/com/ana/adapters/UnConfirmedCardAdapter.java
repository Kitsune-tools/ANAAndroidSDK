...
public class UnConfirmedCardAdapter extends SectionAdapter<Section> {


    public UnConfirmedCardAdapter(Context context) {
        super(context);
    }
    ...
    private class UnconfirmedAddressCardViewHolder extends RecyclerView.ViewHolder {
        ...
        public UnconfirmedAddressCardViewHolder(View itemView) {
            ...
            tvEdit = (TextView) itemView.findViewById(R.id.tv_addr_edit);
            tvConfirm = (TextView) itemView.findViewById(R.id.tv_addr_confirm);
        }
    }
}
