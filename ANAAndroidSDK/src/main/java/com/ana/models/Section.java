...
public class Section implements Serializable {
    ...
    public Node getCardModel() {
        return cardModel;
    }

    public void setCardModel(Node cardModel) {
    ...
    public void setAnimApplied(boolean animApplied) {
        isAnimApplied = animApplied;
    }
